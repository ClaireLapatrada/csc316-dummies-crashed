class TimeSliderWithHours {
    constructor(containerSelector, timeBuckets, callbacks) {
        ...
        this.timePeriods = [
            { name: "Morning", start: 6, end: 12, color: "#f4a261" },    // 6 AM - 12 PM (UPPER RIGHT) - Bright yellow
            { name: "Afternoon", start: 12, end: 18, color: "#e36040" }, // 12 PM - 6 PM (LOWER RIGHT) - Orange
            { name: "Evening", start: 18, end: 24, color: "#2a9d8f" },    // 6 PM - 12 AM (LOWER LEFT) - Purple
            { name: "Night", start: 0, end: 6, color: "#264653" }        // 12 AM - 6 AM (UPPER LEFT) - Dark blue
        ];
